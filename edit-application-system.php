...
<header class="bg-ledger-navy text-white">
  <div class="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
    ...
    <a href="application-systems-summary.php" class="text-xs font-semibold tracking-wide border border-white/30 px-4 py-2 hover:bg-white/10 transition-colors">BACK TO SUMMARY</a>
  </div>
</header>
...
<div class="max-w-3xl mx-auto px-6 py-10">
  ...
  <form action="edit-application-system.php?id=<?= $id ?>" method="POST" class="bg-white border border-ledger-line shadow-sm p-8">
