...
if ($progress['app_count'] > 0) {
    ...
    if ($progress['ict_done']) {
        $backLinks[] = ['url' => survey_summary_url('projects'), 'label' => 'BACK TO PROJECTS SUMMARY'];
    }
} elseif ($progress['first_survey_type'] === 'projects') {
    // Projects is survey 1 — this (systems) is survey 2, and this is the
...
<script>
(function () {
  var DRAFT_KEY = 'draft_application_systems';
  var form = document.getElementById('appsysForm');
  if (!form) return;
