...
if ($progress['first_survey_type'] === 'projects') {
    // Projects is survey 1 — this (systems) is survey 2. Back goes to
    // survey 1's summary, not the chooser (which no longer applies).
    $backUrl = survey_summary_url('projects');
    $backLabel = 'BACK TO PROJECTS SUMMARY';
} else {
